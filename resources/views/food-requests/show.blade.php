        ...
        <div class="flex-1">
            <header class="bg-white shadow-md p-6 flex justify-between items-center">
                <div class="flex items-center">
                    <a href="{{ route('food-requests.index') }}" class="text-gray-600 hover:text-gray-800 mr-4">
            ...
            <div class="p-8">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-between">
                        <a href="{{ route('food-requests.index') }}" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg transition-colors shadow-sm hover:shadow-md">
